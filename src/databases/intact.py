...
class IntAct:
    ...
    def download_files(self) -> None:
        ...
        output_dir = f'{path.INTACT}/{self.version}'
    ...
    def reduce_to_plants(self) -> None:
        ...
        # Set up file paths
        all_filepath = f'{path.INTACT}/{self.version}/intact.txt'
        plant_filepath = f'{path.INTACT}/{self.version}/plants.txt'
    ...
    def _grep(self, uniprot_id: str) -> pd.DataFrame:
        ...
        # Set up file path
        file_path = f'{path.INTACT}/{self.version}/plants.txt'
